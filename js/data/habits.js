const HABIT_LIBRARY = [
  // ============ 运动健身 ============
  {id:'morning_run',name:'晨跑',icon:'🏃',category:'sport',timePeriod:'morning',type:'timer',unit:'分钟',tip:'建议20-30分钟，微汗即可'},
  {id:'evening_walk',name:'散步',icon:'🚶',category:'sport',timePeriod:'evening',type:'timer',unit:'分钟',tip:'饭后30分钟散步15-20分钟'},
  {id:'yoga',name:'瑜伽',icon:'🧘',category:'sport',timePeriod:'morning',type:'timer',unit:'分钟',tip:'30-60分钟，空腹或餐后2小时'},
  {id:'strength',name:'力量训练',icon:'🏋️',category:'sport',timePeriod:'afternoon',type:'timer',unit:'分钟',tip:'30-45分钟，每周2-3次'},
  {id:'swimming',name:'游泳',icon:'🏊',category:'sport',timePeriod:'afternoon',type:'timer',unit:'分钟',tip:'30-45分钟，每周2-3次'},
  {id:'cycling',name:'骑车',icon:'🚴',category:'sport',timePeriod:'forenoon',type:'timer',unit:'分钟',tip:'30-60分钟，中等强度'},
  {id:'jump_rope',name:'跳绳',icon:'🤸',category:'sport',timePeriod:'forenoon',type:'count',unit:'个',tip:'1000-3000个/次，分组进行'},
  {id:'stretch',name:'拉伸放松',icon:'🤸',category:'sport',timePeriod:'evening',type:'timer',unit:'分钟',tip:'10-15分钟全身拉伸，放松肌肉'},
  ...
  // ============ 心灵修养 ============
  {id:'meditation',name:'冥想',icon:'🧘',category:'mind',timePeriod:'morning',type:'timer',unit:'分钟',tip:'10-15分钟，正念冥想有助减压'},
  ...
  {id:'lie_protect',name:'扩胸运动',icon:'🛏️',category:'protect',timePeriod:'forenoon',type:'count',unit:'次',tip:'久卧伤气，适度活动扩胸'},
  ...
  {id:'eye_rest',name:'眼睛休息',icon:'👁️',category:'protect',timePeriod:'forenoon',type:'count',unit:'次',defaultReminder:{time:'10:00'},tip:'每用眼20分钟，远眺20秒'},
  ...
  {id:'hair_care',name:'护发',icon:'💇',category:'care',timePeriod:'evening',type:'boolean',unit:'',tip:'定期修剪，使用护发素/发膜'},
