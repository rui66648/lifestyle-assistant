...
const REF_BOOKS = [
  {name:'《黄帝内经》',author:'先秦 · 黄帝/岐伯',type:'ancient',emoji:'🏛️',desc:'中医养生理论之源',url:'references/黄帝内经/黄帝内经.html'},
  {name:'《遵生八笺》',author:'明代 · 高濂',type:'ancient',emoji:'🌿',desc:'古代养生百科全书',url:'references/遵生八笺/遵生八笺.html'},
  {name:'《老老恒言》',author:'清代 · 曹庭栋',type:'ancient',emoji:'👴',desc:'老年养生专著',url:'references/老老恒言/老老恒言.html'},
  {name:'《饮膳正要》',author:'元代 · 忽思慧',type:'ancient',emoji:'🍲',desc:'宫廷营养学专著',url:'references/饮膳正要/饮膳正要.html'},
  {name:'《养生论》',author:'三国 · 嵇康',type:'ancient',emoji:'📜',desc:'首创系统养生专论',url:'references/养生论/养生论.html'},
  {name:'《寿世青编》',author:'清代 · 尤乘',type:'ancient',emoji:'💚',desc:'五脏养生心药之说',url:'references/寿世青编/寿世青编.html'},
  {name:'《备急千金要方》',author:'唐代 · 孙思邈',type:'ancient',emoji:'💊',desc:'药王养性治未病',url:'references/备急千金要方/备急千金要方.html'},
  {name:'《抱朴子》',author:'晋代 · 葛洪',type:'ancient',emoji:'🔮',desc:'道家养生不伤为本',url:'references/抱朴子/抱朴子.html'},
  {name:'《闲情偶寄》',author:'清代 · 李渔',type:'ancient',emoji:'🎋',desc:'生活美学养生先养心',url:'references/闲情偶寄/闲情偶寄.html'},
  {name:'《你是你吃出来的》',author:'现代 · 夏萌',type:'modern',emoji:'🥗',desc:'细胞营养与七大营养素',url:'references/你是你吃出来的/你是你吃出来的.html'},
  {name:'《九种体质养生全书》',author:'现代 · 王琦',type:'modern',emoji:'🧬',desc:'九种体质辨识调理',url:'references/九种体质养生全书/九种体质养生全书.html'},
  {name:'《科学休息》',author:'现代 · 亚历克斯',type:'modern',emoji:'🧠',desc:'注意力网络与四种休息',url:'references/科学休息/科学休息.html'},
  {name:'《求医不如求己》',author:'现代 · 中里巴人',type:'modern',emoji:'💆',desc:'穴位按摩经络保健',url:'references/求医不如求己/求医不如求己.html'},
  {name:'《拉伸》',author:'现代 · 鲍勃',type:'modern',emoji:'🤸',desc:'拉伸动作与办公室拉伸',url:'references/拉伸/拉伸.html'},
  {name:'《黄帝内经说什么》',author:'现代 · 徐文兵/梁冬',type:'modern',emoji:'💬',desc:'对话体解读黄帝内经',url:'references/黄帝内经说什么/黄帝内经说什么.html'},
  {name:'《睡眠革命》',author:'现代 · Nick Littlehales',type:'modern',emoji:'🌙',desc:'R90睡眠方案与现代睡眠科学',url:'references/睡眠革命/睡眠革命.html'},
  {name:'《运动改造大脑》',author:'现代 · John Ratey',type:'modern',emoji:'🧠',desc:'运动与脑科学',url:'references/运动改造大脑/运动改造大脑.html'},
  {name:'《正念的奇迹》',author:'现代 · 一行禅师',type:'modern',emoji:'🧘',desc:'正念冥想与身心疗愈',url:'references/正念的奇迹/正念的奇迹.html'},
  {name:'《抗炎生活》',author:'现代 · 池谷敏郎',type:'modern',emoji:'🔥',desc:'慢性炎症与现代疾病预防',url:'references/抗炎生活/抗炎生活.html'},
  {name:'《肠子的小心思》',author:'现代 · 朱莉娅·恩德斯',type:'modern',emoji:'🦠',desc:'肠道菌群与健康',url:'references/肠子的小心思/肠子的小心思.html'},
  {name:'《深度营养》',author:'现代 · 凯瑟琳·沙纳汉',type:'modern',emoji:'🥑',desc:'传统饮食智慧与现代营养学',url:'references/深度营养/深度营养.html'},
  {name:'《控糖革命》',author:'现代 · 杰西·安佐斯佩',type:'modern',emoji:'🍬',desc:'血糖管理与健康饮食',url:'references/控糖革命/控糖革命.html'},
  {name:'《端粒效应》',author:'现代 · 伊丽莎白·布莱克本',type:'modern',emoji:'🧬',desc:'端粒科学与抗衰老',url:'references/端粒效应/端粒效应.html'},
  {name:'《人体运动生理学》',author:'现代 · 运动科学',type:'modern',emoji:'🏃',desc:'能量代谢与运动系统适应',url:'references/人体运动生理学/人体运动生理学.html'},
  {name:'《高级运动营养学》',author:'现代 · 营养科学',type:'modern',emoji:'🥩',desc:'周期化营养与补剂科学',url:'references/高级运动营养学/高级运动营养学.html'},
  {name:'《力量训练基础》',author:'现代 · 力量训练',type:'modern',emoji:'🏋️',desc:'训练原则与周期化模型',url:'references/力量训练基础/力量训练基础.html'},
  {name:'《运动医学与康复》',author:'现代 · 运动医学',type:'modern',emoji:'🩺',desc:'损伤预防与康复方案',url:'references/运动医学与康复/运动医学与康复.html'}
];
...
const HEALTH_TIPS = [
  ...
  {habit:'daily_water',text:'成年人每天建议饮水1500-2000ml（约8杯），少量多次效果最佳。',source:'食饮有节，谨和五味。--《素问·上古天真论》',refBook:'黄帝内经'},
...
const BODY_CLOCK = [
  ...
  {id:'maoshi',name:'卯时',start:5,end:7,meridian:'大肠经',action:'起床·排便',detail:'大肠经当令，阳气初生',icon:'🌅',color:'#F4A683'},
